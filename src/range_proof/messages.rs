//! The `messages` module contains the API for the messages passed between the
//! parties and the dealer in an aggregated multiparty computation protocol.
//!
//! For more explanation of how the `dealer`, `party`, and `messages` modules
//! orchestrate the protocol execution, see [the API for the aggregated
//! multiparty computation
//! protocol](../aggregation/index.html#
...
impl ProofShare {
	/// Checks consistency of all sizes in the proof share and returns the size
	/// of the l/r vector.
